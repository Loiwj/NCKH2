...
checkpoint = ModelCheckpoint(
    "best_model_EfficientNetB4_v2_tangcuong.keras",
...
for fold_no, (train_indices, test_indices) in enumerate(
    ...
    metrics_logger = MetricsLogger(
        f"metrics_EfficientNetB4_v2_tangcuong_fold_{fold_no}.log",
        X_val,
        y_val,
        fold_no,
        f"confusion_matrix_EfficientNetB4_v2_tangcuong",
    )
    ...
    save_classification_report(
        ...
        y_pred,
        class_names,
        f"classification_report_EfficientNetB4_v2_tangcuong.txt",
    )
